...
\title{Energias renováveis e desenvolvimento econômico no Nordeste}
...
\framesubtitle{Desenvolvimento Econômico e Regional}
\begin{itemize}
    \item Desenvolvimento econômico vai além do crescimento da produção e renda -- envolve também transformações sociais e qualidade de vida
    \item Desenvolvimento regional ocorre de forma \textbf{desigual}, por diferenças de infraestrutura, recursos e investimentos entre territórios
    \item Base teórica: Myrdal (1957), Perroux (1955) e Hirschman (1958) -- concentração espacial do crescimento e efeitos diferenciados entre regiões
    \item Celso Furtado: desigualdades estruturais e especificidades históricas do Nordeste
    \item Infraestrutura (inclusive energética) favorece atividades produtivas e atrai investimentos
\end{itemize}
\end{frame}
\begin{frame}
\frametitle{Referencial Teórico}
\framesubtitle{Energia Renovável como Fator de Desenvolvimento}
\begin{itemize}
    \item Expansão de renováveis gera efeitos além da geração de eletricidade -- investimentos, serviços e mão de obra estimulam economias locais
    \item Oliveira, Uhr e Uhr (2026): parques eólicos no NE (2001--2020) aumentaram a renda formal (agricultura, construção, serviços) e reduziram a desigualdade de renda
    \item Barbosa (2024) e Freire e Fontgalland (2022) também investigam os impactos econômicos da energia renovável na região
    \item Efeitos dependem das características naturais, infraestrutura e capacidade de atração de investimentos de cada território
\end{itemize}
\end{frame}
\begin{frame}
\frametitle{Referencial Teórico}
\framesubtitle{Desenvolvimento Regional no Nordeste Brasileiro}
\begin{itemize}
    \item Nordeste apresenta desigualdades históricas, tanto frente às demais regiões do Brasil quanto entre seus próprios estados
    \item Expansão das renováveis é uma transformação recente da estrutura econômica regional, atraindo investimentos e formando novos polos energéticos
    \item Desenvolvimento regional resulta de \textbf{múltiplos fatores} (emprego, renda, infraestrutura, políticas públicas) -- energia renovável é um fator associado, não o único determinante
\end{itemize}
\end{frame}
\begin{frame}
...
\section{Metodologia}
\begin{itemize}
    \item Abordagem \textbf{quantitativa}, de caráter descritivo e exploratório
    \item Dados secundários dos \textbf{9 estados do Nordeste} (2010--2024), totalizando \textbf{126 observações}
    \item Variáveis: Potência Energética Acumulada em MW (ANEEL) x Índice de Desenvolvimento Humano Municipal (IDHM)
    \item Estatística descritiva (média, mediana, quartis, desvio padrão) e comparações 2010 vs. 2024 com gráficos de linhas, boxplots e dispersão
    \item Coeficiente de correlação de Pearson -- mede associação, não causalidade
    \item Análises realizadas no \textbf{software R}
\end{itemize}
\end{frame}
\begin{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{figs/imagem_2026-08-02_131054849.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figs/imagem_2026-08-02_132214045.png}
    \caption{Fonte: Resultados da pesquisa baseados nos dados da ANEEL e IDHM.}
\end{figure}
\end{frame}
\begin{frame}
\frametitle{Análise de Dados e Discussão dos Resultados}
...
\begin{frame}
\frametitle{Análise de Dados e Discussão dos Resultados}
\framesubtitle{Boxplot e Tendências}
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figs/boxplot 1.jpg}
    \caption{Fonte: Resultados da pesquisa baseados nos dados da ANEEL e IDHM.}
\end{figure}
\end{frame}
\begin{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figs/boxplot 2.jpg}
    \caption{Fonte: Resultados da pesquisa baseados nos dados da ANEEL e IDHM.}
\end{figure}
\end{frame}
\begin{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figs/dispersao 2.jpg}
    \caption{Fonte: Resultados da pesquisa baseados nos dados da ANEEL e IDHM.}
\end{figure}
\end{frame}
\begin{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figs/matriz de correlacao de pearson.jpg}
    \caption{Fonte: Resultados da pesquisa baseados nos dados da ANEEL e IDHM.}
\end{figure}
\end{frame}
\begin{frame}
